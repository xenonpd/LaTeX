...
\usepackage{titlesec} %below here is where you define how the chapters, sections and subsections should look
...
\begin{titlepage} % uses the titling package to enable multiple title pages, enabling multiple title pages
	test
\end{titlepage}
